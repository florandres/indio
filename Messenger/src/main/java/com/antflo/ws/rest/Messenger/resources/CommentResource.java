...
import com.antflo.ws.rest.Messenger.service.CommentService;
...
public class CommentResource {
	...
	@PUT
	@Path("/{commentId}")
	public Comment updateComment(@PathParam("messageId")int messageId, @PathParam("commendId") int id, Comment comment){
		comment.setId(id);
