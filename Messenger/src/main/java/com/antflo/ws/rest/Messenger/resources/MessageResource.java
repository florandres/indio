package com.antflo.ws.rest.Messenger.resources;
...
import com.antflo.ws.rest.Messenger.service.MessageService;
...
public class MessageResource {
	...
	public List<Message> getJsonMessages(@BeanParam MessageFilterBean filterBean){
		...
		return messageService.getAllMesagges();
	}*/
...
private String getUriForProfile (UriInfo uriInfo, Message message){
	URI uri = uriInfo.getAbsolutePathBuilder().path(ProfileResource.class).path(message.getAuthor()).build();
	return uri.toString();
}
